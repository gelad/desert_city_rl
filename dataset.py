...
def initialize():
    ...
    load_templates()  # loading ability and entity templates
    ...
    #                                          init_kwargs={'name': 'Wall', 'data_id': 'wall_sandstone', 'description': 'A sandstone wall.',
    ...
    #                                                effects.Effect('BLOCK_SLASHING', 30),
    #                                                effects.Effect('BLOCK_PIERCING', 30)],
    #                                          init_kwargs={'name': 'Small window', 'data_id': 'window_small_sandstone',
    ...
    #                                                effects.Effect('BLOCK_SLASHING', 30),
    #                                                effects.Effect('BLOCK_PIERCING', 30)],
    #                                          init_kwargs={'name': 'Large window', 'data_id': 'window_large_sandstone',
    ...
    #                                                effects.Effect('BLOCK_SLASHING', 30),
    #                                                effects.Effect('BLOCK_PIERCING', 30)],
    #                                          init_kwargs={'name': 'Pile of sandstone blocks', 'data_id': 'debris_large_sandstone',
    #                                                       'occupies_tile': False, 'blocks_los': False, 'blocks_shots': 0,
    ...
    #                                          init_kwargs={'name': 'Pile of wooden debris', 'data_id': 'debris_large_wooden',
    #                                                   'occupies_tile': False,'blocks_los': False, 'blocks_shots': 0,
    ...
    #                                                effects.Effect('BLOCK_PIERCING', 30)],
    #                                          init_kwargs={'name': 'Wooden board', 'data_id': 'furn_wooden_board',
    ...
    #                                                effects.Effect('BLOCK_SLASHING', 10),
    #                                                effects.Effect('BLOCK_PIERCING', 30)],
    #                                          init_kwargs={'name': 'Wooden wheel', 'data_id': 'furn_wooden_wheel',
    ...
    #                                                effects.Effect('BLOCK_SLASHING', 10),
    #                                                effects.Effect('BLOCK_PIERCING', 30)],
    #                                          init_kwargs={'name': 'Wooden counter', 'data_id': 'furn_wooden_counter',
    #                                                   'occupies_tile': False, 'blocks_los': False, 'blocks_shots': 0.25,
    #                                                   'armor': {'bashing': 200, 'slashing': 100, 'piercing': 300},
    #                                                   'pass_cost': 2,
