...
class Game:
    ...
    def new_game(self):
        ...
        self.equipment_merchant = Merchant(name='William McSidor', sell_ratio=4.0, buy_ratio=0.25,
                                           stock=[('item_healing_potion', 3, 1),
                                                  ('item_antidote_potion', 1, 1),
                                                  ('item_antidote_potion', 1, 0.75),
                                                  ('item_haste_potion', 1, 0.25),
                                                  ('item_wooden_buckler', 1, 0.5),
                                                  ('item_bronze_tipped_arrow', 1, 0.90),
                                                  ('item_bronze_tipped_arrow', 1, 0.60),
                                                  ('item_bronze_tipped_arrow', 1, 0.30),
                                                  ('item_poisoned_arrow', 1, 0.10),
                                                  ('item_frost_arrow', 1, 0.05),
                                                  ('item_bronze_bolt', 1, 0.90),
                                                  ('item_bronze_bolt', 1, 0.60),
                                                  ('item_bronze_bolt', 1, 0.30),
                                                  ('item_explosive_bolt', 1, 0.05),
                                                  ('item_throwing_knife', 1, 0.75),
                                                  ('item_throwing_knife', 1, 0.35),
                                                  ('item_explosive_potion', 1, 0.05),
                                                  ('item_tabar', 1, 0.10),
                                                  ('item_assegai', 1, 0.20),
                                                  ('item_sabre', 1, 0.15),
                                                  ('item_mace', 1, 0.10),
                                                  ('item_zweihander', 1, 0.01),
                                                  ('item_panabas', 1, 0.01),
                                                  ('item_longsword', 1, 0.01),
                                                  ('item_short_bow', 1, 0.15),
                                                  ('item_hunting_crossbow', 1, 0.10),
                                                  ('item_javelin', 1, 0.15),
                                                  ('item_firebolt_scroll', 1, 0.05),
                                                  ('item_frostbolt_scroll', 1, 0.05),
                                                  ('item_misurka', 1, 0.05),
                                                  ('item_mail_armor', 1, 0.05),
                                                  ('item_iron_pauldrons', 1, 0.05),
                                                  ('item_iron_boots', 1, 0.05),
                                                  ('item_iron_armguards', 1, 0.05),
                                                  ('item_mail_leggings', 1, 0.05),
                                                  ('item_leather_cap', 1, 0.10),
                                                  ('item_leather_armor', 1, 0.10),
                                                  ('item_leather_pauldrons', 1, 0.07),
                                                  ('item_leather_boots', 1, 0.07),
                                                  ('item_leather_armguards', 1, 0.07),
                                                  ('item_leather_leggings', 1, 0.07)],
